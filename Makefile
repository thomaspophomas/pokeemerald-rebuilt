...
FEATURE_MULTIPLAYER_SMOKE_STATUS ?= 0
FEATURE_MULTIPLAYER_COMPANION_SAVE_BEACON ?= 0
...
CPPFLAGS += -DFEATURE_MULTIPLAYER_LINK_TRANSPORT=$(FEATURE_MULTIPLAYER_LINK_TRANSPORT)
CPPFLAGS += -DFEATURE_MULTIPLAYER_AUTOCONNECT=$(FEATURE_MULTIPLAYER_AUTOCONNECT)
CPPFLAGS += -DFEATURE_MULTIPLAYER_SMOKE_STATUS=$(FEATURE_MULTIPLAYER_SMOKE_STATUS)
CPPFLAGS += -DFEATURE_MULTIPLAYER_COMPANION_SAVE_BEACON=$(FEATURE_MULTIPLAYER_COMPANION_SAVE_BEACON)
ifeq ($(MODERN),0)
